...
infra_rules = [
    ...
    alert("ecom-a09b-node-mem", "A9b 节点内存 > 90%",
          ...
          0.90, "15m", "warning",
          "节点 {{ $labels.k8s_node_name }} 内存超 90%。集群只有 2 个节点,一台吃紧另一台也接不住,优先看 top pod。"),
    alert("ecom-a10-disk", "A10a 磁盘使用率 > 85%",
          ...
          0.85, "30m", "critical",
          "节点 {{ $labels.k8s_node_name }} {{ $labels.mountpoint }} 磁盘超 85%。openebs-lvm 的 PV 全钉在 node1,涨满会带崩 PG/VM/Loki。"),
