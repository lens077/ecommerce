...
| TCP | `114.132.233.129:52288` PostgreSQL | 可连接 | **明文，无证书** |
...
| PostgreSQL | `114.132.233.129:30001` | TCP + PostgreSQL TLS 握手成功 | Pigsty CA leaf |
| Redis | `114.132.233.129:30002` | TLS 握手成功 | Pigsty CA leaf |
| Kafka DEV | `114.132.233.129:30004` | TCP 可连接 | `SASL_PLAINTEXT`，无证书 |
