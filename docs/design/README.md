...
| [platform/capacity-balancing.md](platform/capacity-balancing.md) | VPA recommendation、可信 requests、节点重启、Descheduler 准入、容量/故障演练与持续告警 | 2026-08-29 三节点调度审计与 VPA recommendation-only 发布报告 |
