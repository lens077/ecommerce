...
- [x] **node3 迁移与可观测外移（2026-08-24，11 条已完成，证据归档）** → [`docs/progress-archive/node3-migration-20260824.md`](progress-archive/node3-migration-20260824.md)
...
- [x] **已完成的 10 项证据已归档**（2026-08-19~08-24：dragonfly Passthrough、CNPG TLSRoute、MinIO TLS、node2 接入 Pangolin、gorse 恢复、彻底登出、node1 Redis TLS、端口随机化、harbor 修复、Redis 持久化卷）→ [`docs/progress-archive/tls-convergence-done-20260824.md`](progress-archive/tls-convergence-done-20260824.md)
