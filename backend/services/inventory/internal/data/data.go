...
import (
	...
	"github.com/lens077/ecommerce/backend/services/inventory/internal/pkg/dbutil"
	"github.com/lens077/ecommerce/backend/services/inventory/internal/pkg/log"
...
func (d *Data) ExecTx(ctx context.Context, fn func(context.Context) error) error {
	...
	if err := fn(txCtx); err != nil {
		// d.log.Warnf("rollback transaction, reason: %v", err)
	...
	if err := tx.Commit(ctx); err != nil {
		// d.log.Errorf("commit failed: %v", err)
