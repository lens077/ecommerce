...
func (*Search) Descriptor() ([]byte, []int) {
	return file_services_inventory_internal_conf_v1_conf_proto_rawDescGZIP(), []int{7}
}
...
func (x *Discovery_Consul_Check_TTL) Reset() {
	*x = Discovery_Consul_Check_TTL{}
	mi := &file_services_inventory_internal_conf_v1_conf_proto_msgTypes[28]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Search_ElasticSearch) Reset() {
	*x = Search_ElasticSearch{}
	mi := &file_services_inventory_internal_conf_v1_conf_proto_msgTypes[29]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Search_ElasticSearch) Descriptor() ([]byte, []int) {
	return file_services_inventory_internal_conf_v1_conf_proto_rawDescGZIP(), []int{7, 0}
}
...
func (x *Search_ElasticSearch_Tls) Reset() {
	*x = Search_ElasticSearch_Tls{}
	mi := &file_services_inventory_internal_conf_v1_conf_proto_msgTypes[30]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Search_ElasticSearch_Tls) Descriptor() ([]byte, []int) {
	return file_services_inventory_internal_conf_v1_conf_proto_rawDescGZIP(), []int{7, 0, 0}
}
...
const file_services_inventory_internal_conf_v1_conf_proto_rawDesc = "" +
	...
	"\x06enable\x18\x01 \x01(\bR\x06enable\x120\n" +
	"\x14insecure_skip_verify\x18\x02 \x01(\bR\x12insecureSkipVerify\x12\x15\n" +
	"\x06ca_pem\x18\x03 \x01(\tR\x05caPemB\xa6\x01\n" +
...
var file_services_inventory_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
