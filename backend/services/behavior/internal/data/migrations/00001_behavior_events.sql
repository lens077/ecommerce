-- 行为服务初始结构。
-- 2026-08-21 由 schema/behavior_events.sql 原样转为 goose 版本化迁移（DDL 语义未动）；
-- 存量环境先 `dbmigrate -svc behavior baseline` 记账。
...
-- +goose Down
DROP TABLE IF EXISTS behaviors.events;
DROP SCHEMA IF EXISTS behaviors;
