...
func NewHTTPServer(
	lc fx.Lifecycle,
	cfg *conf.Bootstrap,
	cartv1Service cartv1connect.CartServiceHandler,
	logger *zap.Logger,
	...
	// 注册 Connect 业务处理器
	cartv1connectPath, cartv1connectHandler := cartv1connect.NewCartServiceHandler(
		cartv1Service,
		combinedOptions...,
	)
	mux.Handle(cartv1connectPath, cartv1connectHandler)
