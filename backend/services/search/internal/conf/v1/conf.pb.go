...
const file_services_search_internal_conf_v1_conf_proto_rawDesc = "" +
	"\n" +
	"+services/search/internal/conf/v1/conf.proto\x12\aconf.v1\x1a#third_party/validate/validate.proto\"\xeb\x02\n" +
	"\tBootstrap\x12/\n" +
...
var file_services_search_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
