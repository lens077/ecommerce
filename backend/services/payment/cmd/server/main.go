...
import (
	...
	logger "github.com/lens077/ecommerce/backend/services/payment/internal/pkg/log"
	"github.com/lens077/ecommerce/backend/services/payment/internal/pkg/meta"
	"github.com/lens077/ecommerce/backend/services/payment/internal/pkg/otel"
	"github.com/lens077/ecommerce/backend/services/payment/internal/pkg/registry"
	"github.com/lens077/ecommerce/backend/services/payment/internal/server"
	"github.com/lens077/ecommerce/backend/services/payment/internal/service"
...
func appOptions(serviceName, deploymentMode, serviceVersion string) []fx.Option {
	...
	return []fx.Option{
		...
		fx.Provide(func(conf *confv1.Bootstrap) *confv1.Pay {
			return conf.Pay
		}),
		otel.Module,
