...
func (*Log_Framework) Descriptor() ([]byte, []int) {
	return file_services_user_internal_conf_v1_conf_proto_rawDescGZIP(), []int{1, 0}
}
...
func (*Log_Application) Descriptor() ([]byte, []int) {
	return file_services_user_internal_conf_v1_conf_proto_rawDescGZIP(), []int{1, 1}
}
...
func (*Log_ElasticSearch) Descriptor() ([]byte, []int) {
	return file_services_user_internal_conf_v1_conf_proto_rawDescGZIP(), []int{1, 2}
}
...
func (*Server_Cors) Descriptor() ([]byte, []int) {
	return file_services_user_internal_conf_v1_conf_proto_rawDescGZIP(), []int{2, 1}
}
...
func (x *Discovery_Consul_Tls) Reset() {
	*x = Discovery_Consul_Tls{}
	mi := &file_services_user_internal_conf_v1_conf_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Discovery_Consul_Check) Reset() {
	*x = Discovery_Consul_Check{}
	mi := &file_services_user_internal_conf_v1_conf_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Discovery_Consul_Check_TTL) Reset() {
	*x = Discovery_Consul_Check_TTL{}
	mi := &file_services_user_internal_conf_v1_conf_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Discovery_Consul_Check_TTL) Descriptor() ([]byte, []int) {
	return file_services_user_internal_conf_v1_conf_proto_rawDescGZIP(), []int{6, 0, 1, 0}
}
...
const file_services_user_internal_conf_v1_conf_proto_rawDesc = "" +
	"\n" +
	")services/user/internal/conf/v1/conf.proto\x12\aconf.v1\x1a#third_party/validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xc8\x02\n" +
	"\tBootstrap\x12/\n" +
...
var file_services_user_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
