...
const file_services_order_internal_conf_v1_conf_proto_rawDesc = "" +
	"\n" +
	"*services/order/internal/conf/v1/conf.proto\x12\aconf.v1\x1a#third_party/validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\"\x99\x03\n" +
	"\tBootstrap\x12/\n" +
...
var file_services_order_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_services_order_internal_conf_v1_conf_proto_goTypes = []any{
	...
	(*Search_ElasticSearch)(nil),                // 27: conf.v1.Search.ElasticSearch
	(*Search_ElasticSearch_Tls)(nil),            // 28: conf.v1.Search.ElasticSearch.Tls
...
var file_services_order_internal_conf_v1_conf_proto_depIdxs = []int32{
	...
	27, // 17: conf.v1.Search.elastic_search:type_name -> conf.v1.Search.ElasticSearch
	...
	25, // 27: conf.v1.Discovery.Consul.check:type_name -> conf.v1.Discovery.Consul.Check
	26, // 28: conf.v1.Discovery.Consul.Check.ttl:type_name -> conf.v1.Discovery.Consul.Check.TTL
	29, // 29: conf.v1.Discovery.Consul.Check.TTL.ping_interval:type_name -> google.protobuf.Duration
	28, // 30: conf.v1.Search.ElasticSearch.tls:type_name -> conf.v1.Search.ElasticSearch.Tls
