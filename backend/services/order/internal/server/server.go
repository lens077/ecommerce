...
func NewHTTPServer(
	lc fx.Lifecycle,
	cfg *conf.Bootstrap,
	orderv1Service orderv1connect.OrderServiceHandler,
	logger *zap.Logger,
	...
	orderv1connectPath, orderv1connectHandler := orderv1connect.NewOrderServiceHandler(
		orderv1Service,
		combinedOptions...,
	)
	mux.Handle(orderv1connectPath, orderv1connectHandler)
