...
const file_services_product_internal_conf_v1_conf_proto_rawDesc = "" +
	"\n" +
	",services/product/internal/conf/v1/conf.proto\x12\aconf.v1\x1a#third_party/validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x82\x03\n" +
	"\tBootstrap\x12/\n" +
	...
	"\trecommend\x18\b \x01(\v2\x12.conf.v1.RecommendB\x06\xbaH\x03\xc8\x01\x00R\trecommendJ\x04\b\x06\x10\aR\x06search\"\xff\x03\n" +
	"\tRecommend\x12.\n" +
...
var file_services_product_internal_conf_v1_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_services_product_internal_conf_v1_conf_proto_goTypes = []any{
	...
	(*Recommend_Gorse)(nil),                     // 8: conf.v1.Recommend.Gorse
	(*Recommend_ItemSync)(nil),                  // 9: conf.v1.Recommend.ItemSync
...
var file_services_product_internal_conf_v1_conf_proto_depIdxs = []int32{
	...
	1,  // 6: conf.v1.Bootstrap.recommend:type_name -> conf.v1.Recommend
	8,  // 7: conf.v1.Recommend.gorse:type_name -> conf.v1.Recommend.Gorse
	9,  // 8: conf.v1.Recommend.item_sync:type_name -> conf.v1.Recommend.ItemSync
	...
	31, // 21: conf.v1.Recommend.Gorse.timeout:type_name -> google.protobuf.Duration
	31, // 22: conf.v1.Recommend.ItemSync.interval:type_name -> google.protobuf.Duration
	31, // 23: conf.v1.Recommend.ItemSync.cursor_lookback:type_name -> google.protobuf.Duration
	31, // 24: conf.v1.Server.HTTP.read_timeout:type_name -> google.protobuf.Duration
	31, // 25: conf.v1.Server.HTTP.write_timeout:type_name -> google.protobuf.Duration
	31, // 26: conf.v1.Server.HTTP.idle_timeout:type_name -> google.protobuf.Duration
	17, // 27: conf.v1.Data.Database.postgres:type_name -> conf.v1.Data.Database.Postgres
	20, // 28: conf.v1.Data.Cache.redis:type_name -> conf.v1.Data.Cache.Redis
	18, // 29: conf.v1.Data.Database.Postgres.pool:type_name -> conf.v1.Data.Database.Postgres.DatabasePool
	19, // 30: conf.v1.Data.Database.Postgres.tls:type_name -> conf.v1.Data.Database.Postgres.Tls
	31, // 31: conf.v1.Data.Database.Postgres.DatabasePool.max_conn_lifetime:type_name -> google.protobuf.Duration
	31, // 32: conf.v1.Data.Database.Postgres.DatabasePool.max_conn_idle_time:type_name -> google.protobuf.Duration
	31, // 33: conf.v1.Data.Database.Postgres.DatabasePool.ping_timeout:type_name -> google.protobuf.Duration
	31, // 34: conf.v1.Data.Cache.Redis.dial_timeout:type_name -> google.protobuf.Duration
	31, // 35: conf.v1.Data.Cache.Redis.read_timeout:type_name -> google.protobuf.Duration
	31, // 36: conf.v1.Data.Cache.Redis.write_timeout:type_name -> google.protobuf.Duration
	21, // 37: conf.v1.Data.Cache.Redis.tls:type_name -> conf.v1.Data.Cache.Redis.Tls
	26, // 38: conf.v1.Observability.Trace.tls:type_name -> conf.v1.Observability.Tls
	32, // 39: conf.v1.Observability.Trace.sample_ratio:type_name -> google.protobuf.DoubleValue
	26, // 40: conf.v1.Observability.Metric.tls:type_name -> conf.v1.Observability.Tls
	31, // 41: conf.v1.Observability.Metric.export_interval:type_name -> google.protobuf.Duration
	26, // 42: conf.v1.Observability.Logging.tls:type_name -> conf.v1.Observability.Tls
	28, // 43: conf.v1.Discovery.Consul.tls:type_name -> conf.v1.Discovery.Consul.Tls
	29, // 44: conf.v1.Discovery.Consul.check:type_name -> conf.v1.Discovery.Consul.Check
	30, // 45: conf.v1.Discovery.Consul.Check.ttl:type_name -> conf.v1.Discovery.Consul.Check.TTL
	31, // 46: conf.v1.Discovery.Consul.Check.TTL.ping_interval:type_name -> google.protobuf.Duration
