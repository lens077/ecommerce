...
func (*Observability_Metric) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{4, 1}
}
...
func (*Observability_Logging) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{4, 2}
}
...
func (*Observability_Tls) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{4, 3}
}
...
func (*Discovery_Consul_Tls) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{5, 0, 0}
}
...
func (*Discovery_Consul_Check) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{5, 0, 1}
}
...
func (*Discovery_Consul_Check_TTL) Descriptor() ([]byte, []int) {
	return file_internal_conf_v1_conf_proto_rawDescGZIP(), []int{5, 0, 1, 0}
}
...
const file_internal_conf_v1_conf_proto_rawDesc = "" +
	"\n" +
	"\x1binternal/conf/v1/conf.proto\x12\aconf.v1\x1a#third_party/validate/validate.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\x8f\x02\n" +
	"\tBootstrap\x12/\n" +
	...
	"\x14insecure_skip_verify\x18\x03 \x01(\bR\x12insecureSkipVerify\"\xcd\x05\n" +
	"\rObservability\x122\n" +
	...
	"\x06enable\x18\x04 \x01(\bR\x06enable\x1a\x9c\x01\n" +
	"\x05Trace\x12$\n" +
	...
	"\fsample_ratio\x18\x03 \x01(\v2\x1c.google.protobuf.DoubleValueR\vsampleRatio\x1a\xa0\x01\n" +
	"\x06Metric\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x80\x02\x01R\bendpoint\x12,\n" +
	"\x03tls\x18\x02 \x01(\v2\x1a.conf.v1.Observability.TlsR\x03tls\x12B\n" +
	"\x0fexport_interval\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\x0eexportInterval\x1a]\n" +
	"\aLogging\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xbaH\x05r\x03\x80\x02\x01R\bendpoint\x12,\n" +
...
var file_internal_conf_v1_conf_proto_depIdxs = []int32{
	...
	26, // 30: conf.v1.Observability.Trace.sample_ratio:type_name -> google.protobuf.DoubleValue
	20, // 31: conf.v1.Observability.Metric.tls:type_name -> conf.v1.Observability.Tls
	25, // 32: conf.v1.Observability.Metric.export_interval:type_name -> google.protobuf.Duration
	20, // 33: conf.v1.Observability.Logging.tls:type_name -> conf.v1.Observability.Tls
	22, // 34: conf.v1.Discovery.Consul.tls:type_name -> conf.v1.Discovery.Consul.Tls
	23, // 35: conf.v1.Discovery.Consul.check:type_name -> conf.v1.Discovery.Consul.Check
	24, // 36: conf.v1.Discovery.Consul.Check.ttl:type_name -> conf.v1.Discovery.Consul.Check.TTL
	25, // 37: conf.v1.Discovery.Consul.Check.TTL.ping_interval:type_name -> google.protobuf.Duration
