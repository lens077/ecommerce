...
| evolution-log.md | harness 演进日志的**索引**（脚本生成）与写法；条目按月分卷在 `evolution-log/`。改硬规则/门禁前先扫索引，命中再读那一条 |
| evolution-log/2026-09.md | 演进日志 2026-09 卷；条目从索引 evolution-log.md 进来读，不整卷通读 |
| evolution-log/2026-08.md | 演进日志 2026-08 卷；同上 |
