...
description: harness 演进日志 2026-08 卷——每条四要素（改了什么/为什么/触发事故/怎么验证的），按日期倒序；索引与写法见 ../evolution-log.md
---

# Harness 演进日志 · 2026-08

> 本卷只放 2026-08 的条目，倒序。写法与四要素见 [evolution-log.md](../evolution-log.md)；索引由 `scripts/evolution-log-index.py --write` 生成。
