...
- **改了什么**：`evolution-log.md`（142 KB、74 条）拆成 `evolution-log/2026-08.md`（46 条）与 `2026-09.md`（28 条），
...
- **为什么**：「改硬规则 / 门禁前必读」这个动作的成本要和它的频率相称。142 KB 一整份没有索引层，
  ...
  按季分卷等于不分。
- **触发事故**：2026-09-16 对照 Context Engineering 文章审计，量到 evolution-log.md 142 KB、只有 2 个 `##`
